...
static int __init my_mod_init(void)
{
    ...
    counter = 0;
    read_thread1 = kthread_run(reader_function, NULL, "read-thread1");
    read_thread2 = kthread_run(reader_function, NULL, "read-thread2");
    read_thread3 = kthread_run(reader_function, NULL, "read-thread3");
